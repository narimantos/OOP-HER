...
1. Wat is in dit voorbeeld het gevolg wanneer de methoden van de klasse ```TicketService``` onder ```private```: vallen.<details> <summary></summary> ``` Dan zouden de functies van de klasse TicketSerice, die in de main worden aangeroepen niet compilen  ``` </details>
